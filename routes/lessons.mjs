...
export default function APIRoutes(passport) {
  ...
  router.get('/lessons/:id', auth(passport), async (req, res) => {
    try {
  ...
  router.get('/courses/:id/lessons/add', auth(passport), async (req, res) => {
    try {
  ...
  router.post('/comments', auth(passport), async (req, res) => {
    try {
  ...
  router.post('/lessons/add', auth(passport), async (req, res) => {
    try {
      if (!req.body.id) {
